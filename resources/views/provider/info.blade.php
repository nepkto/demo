        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('provider.general-info.update',$info->id) }}">
                            @csrf
                            @method('PATCH')
        ...
        <div class="col-md-12 pt-3">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('provider.profile.update', $info->id) }}">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right">Mobile Num</label>
